...
The Finger Lakes represent 11 of of New York State's monitored water bodies, all near to one another in geogrpahical space and yet all impacted to varying degrees by cyanobacteria.
```{r}
library(gdata)
LakeData=read.xls(Lake_Summary1.xlsx,sheet=1,verbose=F,blank.lines.skip=T,perl="perl")
```
