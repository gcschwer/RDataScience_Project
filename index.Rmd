...
plot(Aspect)
```
The above plot demonstrates the aspect of the land in the Finger Lakes Region. Since aspect informs about the compass direction any given slope faces, understanding the aspect of the terrain is also an important cosideration in trying to understand how water might move through the watershed.
