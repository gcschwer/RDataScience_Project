...
table1$sum_pixels=c(rowSums(table1))
table1$U_prop=c(table1$Urban/table1$sum_pixels)
table1$U_prop=round(table1$U_prop,2)
table1$A_prop=c(table1$Agriculture/table1$sum_pixels)
table1$A_prop=round(table1$A_prop,2)
table1$W_prop=c(table1$Water/table1$sum_pixels)
table1$W_prop=round(table1$W_prop,2)
table1$F_prop=c(table1$Forest/table1$sum_pixels)
table1$F_prop=round(table1$F_prop,2)
table1$B_prop=c(table1$Bare/table1$sum_pixels)
