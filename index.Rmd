...
Now that we have our DEM data for our region of interest around the 11 Finger Lakes, we can call on rgrass7 to attempt to identify the boundaries between each lake's watershed.



```{r, warning=F} 
terrain(x = dem_roi,opt = 'flowdir',unit = 'degrees',neighbors = 8,filename = 'data/FlowDir')
